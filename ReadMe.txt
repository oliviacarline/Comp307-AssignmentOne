...
Assuming the file structure remains unchanged, if you don’t give any arguments, the program should run through the ten test data files created. If you do give arguments, first should be 
